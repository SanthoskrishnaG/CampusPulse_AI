...
CAMPUS_CONFIG = {
    ...
    "locations": [
        ...
        {
            "id": "hostel_men",
            "name": "Student Residential Hostels (Boys Block)",
            "code": "HOSTEL-MEN",
            "category": "HOSTEL",
            "type": "hostel",
            "latitude": 11.0252,
            ...
            "floor_count": 5,
            "capacity": 800,
            "description": "Undergraduate and postgraduate men's residential living, recreation rooms, and study halls.",
            "icon": "🏠",
            "is_verified": True,
            "status": "Wi-Fi Active",
        ...
        {
            "id": "hostel_women",
            "name": "Student Residential Hostels (Girls Block)",
            "code": "HOSTEL-WOMEN",
            "category": "HOSTEL",
            "type": "hostel",
            "latitude": 11.0250,
            ...
            "floor_count": 5,
            "capacity": 600,
            "description": "Women's residential living with biometric security, health desk, reading suites, and courtyard.",
            "icon": "🏡",
            "is_verified": True,
