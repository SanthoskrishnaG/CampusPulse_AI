...
# Campus Defaults
CAMPUS_NAME = os.environ.get('CAMPUS_NAME', 'CampusPulse Central University')
CAMPUS_LAT = float(os.environ.get('CAMPUS_LAT', 12.9716))
CAMPUS_LNG = float(os.environ.get('CAMPUS_LNG', 77.5946))
